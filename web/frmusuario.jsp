<%-- 
    Document   : frmusuario
    Created on : 25-may-2021, 19:19:28
    Author     : Intel i5
--%>
 ...
 <div class="container">
            ...
            <form action="UsuarioControlador" method="post" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="clave" value="${usuario.clave}" placeholder="Escriba su clave">
                </div>
